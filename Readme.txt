...
d. phaseDiag_AlCoW_pv.pdf  : No explanation needed.
...
Good. Hope you did executed the code successfully without any difficulties. You can give another example say (AlNi_pvSc_sv) in test_inp file and see the output. Now if you are curious about how the code runs you can check the executable bash files. Most of the code is commented to some extent. For chekcing the hullq code you can look up the code in hullq folder. Good Luck. !!   
